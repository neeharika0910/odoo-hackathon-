  ...
  head: () => ({
    meta: [
      ...
      { title: "TransitOps — Smart Transport Operations Platform" },
      {
        name: "description",
        content:
          "TransitOps is a premium fleet ERP for managing vehicles, drivers, trips, maintenance, fuel and expenses in one place.",
      },
      ...
      { property: "og:title", content: "TransitOps — Smart Transport Operations Platform" },
      {
        ...
        content:
          "Premium fleet ERP for vehicles, drivers, trips, maintenance, fuel and expenses.",
      },
